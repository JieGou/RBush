...
namespace RTree
{
	...
	public class Rectangle
	{
		...
		/// Constructor
		/// </summary>
		/// <param name="min">array containing the minimum value for each dimension; ie { min(x), min(y) }</param>
		/// <param name="max">array containing the maximum value for each dimension; ie { max(x), max(y) }</param>
		...
		/// </summary>
		/// <returns>return copy of this rectangle</returns>
...
#warning possible didn't convert properly
		...
		/// <summary>
		/// Determine whether this rectangle is the same as another object<br/>
