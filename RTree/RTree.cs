...
namespace RTree
{
	...
	/// for the following features (in order of importance):<br/>
	///
	...
	public class RTree<T>
	{
		...
		/// <summary>
		/// Get the next available Node&lt;T&gt; ID. Reuse deleted Node&lt;T&gt; IDs if possible
		/// </summary>
		/// <returns></returns>
		...
		/// <summary>
		/// Ascend from a leaf Node&lt;T&gt; L to the root, adjusting covering rectangles and propagating Node&lt;T&gt; splits as necessary.
		/// </summary>
		/// <param name="n"></param>
		/// <param name="nn"></param>
		/// <returns></returns>
		...
		/// <summary>
		/// Given a Node<T> object, calculate the Node<T> MBR from it's entries. Used in consistency checking
		/// </summary>
		/// <param name="n"></param>
		/// <returns></returns>
